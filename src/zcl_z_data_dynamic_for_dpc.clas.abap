class ZCL_Z_DATA_DYNAMIC_FOR_DPC definition
  public
...
protected section.
  ...
  methods Z_DATA_TABLESET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_DATA_DYNAMIC_FOR_MPC=>TS_Z_DATA_TABLE
    raising
  ...
  methods Z_DATA_TABLESET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_DATA_DYNAMIC_FOR_MPC=>TT_Z_DATA_TABLE
...
CLASS ZCL_Z_DATA_DYNAMIC_FOR_DPC IMPLEMENTATION.
...
*&* This class has been generated on 02.05.2024 16:19:25 in client 400
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_DATA_DYNAMIC_FOR_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA z_data_tableset_create_entity TYPE zcl_z_data_dynamic_for_mpc=>ts_z_data_table.
...
*-------------------------------------------------------------------------*
*             EntitySet -  Z_DATA_TABLESet
*-------------------------------------------------------------------------*
     WHEN 'Z_DATA_TABLESet'.
*     Call the entity set generated method
    z_data_tableset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = z_data_tableset_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = z_data_tableset_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA z_data_tableset_get_entity TYPE zcl_z_data_dynamic_for_mpc=>ts_z_data_table.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          z_data_tableset_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = z_data_tableset_get_entity
                         es_response_context = es_response_context
          ).

        IF z_data_tableset_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = z_data_tableset_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_DATA_DYNAMIC_FOR_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA z_data_tableset_get_entityset TYPE zcl_z_data_dynamic_for_mpc=>tt_z_data_table.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      z_data_tableset_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = z_data_tableset_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = z_data_tableset_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA z_data_tableset_update_entity TYPE zcl_z_data_dynamic_for_mpc=>ts_z_data_table.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          z_data_tableset_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = z_data_tableset_update_entity
          ).
       IF z_data_tableset_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = z_data_tableset_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_ztest_dty_1 TYPE ztest_dty ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="V2" >| &
               | <sadl:dataSource type="DDIC" name="Z_DATA_TABLESet" binding="ZTEST_DTY" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="Z_DATA_TABLESet" dataSource="Z_DATA_TABLESet" maxEditMode="EX" >| &
               | <sadl:query name="EntitySetDefault">| &
               | </sadl:query>| &
               | <sadl:attribute name="AMOUNT" binding="AMOUNT" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="SERIAL_NO" binding="SERIAL_NO" isOutput="TRUE" isKey="TRUE" />| &
               | <sadl:attribute name="CUSTOMER_NAME" binding="CUSTOMER_NAME" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="CUSTOMER_CLASS" binding="CUSTOMER_CLASS" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="DATE_OF_ENROL" binding="DATE_OF_ENROL" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="TIME_OF_ENROL" binding="TIME_OF_ENROL" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="QUANTITY_SOLD" binding="QUANTITY_SOLD" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="QUANTITY_UNIT" binding="QUANTITY_UNIT" isOutput="TRUE" isKey="FALSE" />| &
               |</sadl:structure>| &
               |</sadl:resultSet>| &
               |</sadl:definition>| .
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml          = lv_sadl_xml
                                                      iv_timestamp         = 20240502161929
                                                      iv_uuid              = 'Z_DATA_DYNAMIC_FORM'
                                                      io_query_control     = me
